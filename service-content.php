...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/service-content" />
            ...
            <div id="accordion" class="my-5"  data-aos="fade-right" data-aos-duration="1000">
               <div class="card  first-bd">
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                     <div class="card-body">
                        To enhance the popularity of a business over an online platform, it is crucial to create user-friendly content. Fortunately, here we help businesses to create relevant and engaging content for websites, blogs, and search engines as per the need of the customers.
                     </div>
                  </div>
               </div>
               <div class="card  second-bd">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                     <div class="card-body">
                      If you want to generate more leads then you will need to create Google-centric content to speedily get noticed in top searches. At SEO TOP SEARCH, we help businesses of all sectors to create captivating content to open up new doors of opportunities.
                     </div>
                  </div>
               </div>
               <div class="card  third-bd">
                  ...
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                     <div class="card-body">
                      For this, you will need to perform comprehensive research to come up with effective content marketing ideas. If you want to attract search engines then you will need to create premium content.
                     </div>
                  </div>
               </div>
               <div class="card  forth-bd">
                  ...
                  <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                     <div class="card-body">
                     If you want to connect with an experienced content marketing team then you will need to explore their client’s portfolio. Don’t forget to explore our recent content writing project of different niche clients.
                     </div>
                  </div>
               </div>
               <div class="card  fifth-bd">
                  ...
                  <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordion">
                     <div class="card-body">
                        Fill out the contact us form shared in the below passage if you want to get veterans content marketing services. For any query related to content marketing feel free to contact us.
                     </div>
                  </div>
               </div>
            </div>
