...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/services" />
...
<section id="service-banner" class="services-banner inner-banner orange-gradient">
   <div class="container">
...
qualified leads and improve your return on investment (ROI).</p>
         ...
         <div class="col-md-12">
            <form class="banner-form four-inputs"  data-aos="fade-up" data-aos-duration="1000">
               <input type="text" placeholder="Enter Name Here" name="search">
               <input type="text" placeholder="Enter Email Here" name="search">
               <input type="text" placeholder="Enter Phone Number" name="search">
               <input type="text" placeholder="Enter Website" name="search">
   ...
   <div class="container">
      <div class="col-md-10 mx-auto">
         <div class="section-top  text-center"  data-aos="fade-down" data-aos-duration="1000">
            ...
            <h3 class="section-head">Need Help with Your Website SEO? Here’s How We Can Help</h3>
         </div>
      </div>
...
<section  class="grey-bg struggle-section all-section">
   <div class="container">
      <div class="row align-items-center order-change">
         <div class="col-sm-6">
            <div data-aos="zoom-in" data-aos-duration="1000">
               <img src="images/service-img.png" alt="Image" class="img-responsive">
            </div>
         </div>
         <div class="col-sm-6">
            <div class="struggle-text" data-aos="fade-left" data-aos-duration="1000">
         ...
         <div class="col-lg-4 col-sm-6">
            <div class="package-box grey-bg"  data-aos="fade-up" data-aos-duration="1000">
               ...
               <div class="package-footer d-flex justify-content-between">
                  <div class="bd-right">
                     <p>Share your idea?</p>
                     <a href="+1-212-913-9084">+1-212-913-9084</a>
                  </div>
                  <div>
                     <p>Want to discuss?</p>
                     <a class="live-btn" href="javascript:;" onclick="$zopim.livechat.window.toggle()">Live Chat Now...</a>
         ...
         <div class="col-lg-4 col-sm-6">
            <div class="package-box grey-bg"  data-aos="fade-up" data-aos-duration="1000">
               ...
               <div class="package-footer d-flex justify-content-between">
                  <div class="bd-right">
                     <p>Share your idea?</p>
                     <a href="tel:15127177466">+1-212-913-9084</a>
                  </div>
                  <div>
                     <p>Want to discuss?</p>
                     <a class="live-btn" href="javascript:;" onclick="$zopim.livechat.window.toggle()">Live Chat Now...</a>
      ...
      <div class="row">
         <div class="col-md-10 mx-auto">
            <div class="section-top text-center"  data-aos="fade-down" data-aos-duration="1000">
               ...
               <h3 class="section-head">We Help Startups & Brands Rank Higher on Google</h3>
            ...
            <div id="accordion" class="my-5"  data-aos="fade-right" data-aos-duration="1000">
               <div class="card  first-bd">
                  <div class="card-header" id="headingOne">
                     <h5 class="mb-0">
                        ...
                        Why My Website Is Not Ranking in Google Search?
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                     <div class="card-body">
                        To rank a website, it is crucial to meet the criteria set by Google. Unfortunately, a great proportion of site owners fails to place their website on the first page of google due to complex processes and competition. In this circumstance, we help business to achieve their goals by analyzing and optimizing their website on their demanded search engines.
                     </div>
                  </div>
               </div>
               <div class="card  second-bd">
                  <div class="card-header" id="headingTwo">
                    ...
                    How Our Website Will Appear on Google First Page?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                     <div class="card-body">
                      If you want to place your website on Google’s top searches then you will need to connect with a professional’s search engine optimizer. Fortunately, here at SEO TOP SEARCH, we help businesses of all sectors to enhance their website visibility by getting ranked over the first page on google.
                     </div>
                  </div>
               </div>
               <div class="card  third-bd">
                  <div class="card-header" id="headingThree">
                     ...
                     Why My Website Ranking Is Suddenly Dropped?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                     <div class="card-body">
                     From competition to low-quality links and google algorithms, there are numerous reasons behind ranking fluctuation. We perform comprehensive audits to come up with an effective solution that can help you regain top ranking over search engines.
                     </div>
                  </div>
               </div>
               <div class="card  forth-bd">
                  <div class="card-header" id="headingfour">
                     <h5 class="mb-0">
                        ...
                        How to Check Website Ranking Over Google & Bing?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                     <div class="card-body">
                     By using different tools, we help clients of different niches to determine the true organic ranking over Google and Bing.
                     </div>
                  </div>
               </div>
               <div class="card  fifth-bd">
                  <div class="card-header" id="headingfive">
                     <h5 class="mb-0">
                        ...
                        I Need an SEO Audit of My Website. What Should I Do?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordion">
                     <div class="card-body">
                        Fill out the contact us form shared on our contact page if you want to get a comprehensive SEO audit for free. For any query related to search engine optimization feel free to communicate with our professionals.
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="col-sm-4  bd-left"> 
        <div class="contact_footer_box py-5"> 
          ...
          <div class="d-flex"  data-aos="fade-up" data-aos-duration="1000"> 
            ...
            <span>  
            <a href="mailto:info@seotopsearch.com">info@seotopsearch.com</a>
            </span>
          </div>
        </div>
      </div>
