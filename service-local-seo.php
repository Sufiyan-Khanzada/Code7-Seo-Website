...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/service-local-seo" />
...
<section id="local-seo-banner" class="services-banner inner-banner orange-gradient">
   <div class="container">
...
we pledge to market your company to the appropriate demographic</p>
         ...
         <div class="col-md-12">
            <form class="banner-form four-inputs"  data-aos="fade-up" data-aos-duration="1000" method="POST" action="https://searchmetop.com/include/sendmail.php">
                                               <input type="hidden" required name="page_url" value="service-local-seo.php" />
      ...
      <div class="row align-items-center order-change">
         <div class="col-sm-6">
            <div data-aos="zoom-in" data-aos-duration="1000">
               <img src="images/local-img.png" alt="Image" class="img-responsive">
            </div>
         </div>
         <div class="col-sm-6">
...
SEO TOP SEARCH.</p>
      ...
      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
         ...
         <!-- <a class="nav-item nav-link active" id="nav-local-tab" data-toggle="tab" href="#nav-local" role="tab" aria-controls="nav-local" aria-selected="false">Local Search Marketing</a> -->
      ...
      <div class="row">
         <div class="col-md-10 mx-auto">
            <div class="section-top text-center"  data-aos="fade-down" data-aos-duration="1000">
               ...
               <p>Take a look below to find answers to the questions we get asked the most regarding Local SEO Services.</p>
            </div>
         </div>
      </div>
      <div class="row">
            ...
            <div id="accordion" class="my-5"  data-aos="fade-right" data-aos-duration="1000">
               <div class="card  first-bd">
                  <div class="card-header" id="headingOne">
                     <h5 class="mb-0">
                        ...
                        How Can Local SEO Enhance My Business?
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                     <div class="card-body">
                      When it comes to enhancing the business ROI, it is crucial to target the local audience over the search engine. You will be glad to know that we help businesses to engage a relevant audience over Google to maximize their website performance.
                     </div>
                  </div>
               </div>
               <div class="card  second-bd">
                  <div class="card-header" id="headingTwo">
                    ...
                    How Do We Know What Works on Local SEO?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                     <div class="card-body">
                     If you want to generate more leads then you will need to target local leads over Google. For this, you will need to follow algorithms set by top search engines that rank businesses of all sectors. We help you to open up new doors of opportunities through local SEO services.
                     </div>
                  </div>
               </div>
               <div class="card  third-bd">
                  <div class="card-header" id="headingThree">
                     <h5 class="mb-0">
                      ...
                      Which Type of Content Should I Need for Local SEO?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                     <div class="card-body">
                     You will need to perform comprehensive research to create content that will match the needs of your local audience. If you want to attract your nearby audience then you must connect with us.
                     </div>
                  </div>
               </div>
               <div class="card  forth-bd">
                  <div class="card-header" id="headingfour">
                     <h5 class="mb-0">
                       ...
                       How to Hire A Local SEO Specialist Team?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                     <div class="card-body">
                      If you are willing to hire a local SEO specialist team then you are at the right place. Communicate with our support team right away to get an instant proposal.
                     </div>
                  </div>
               </div>
               <div class="card  fifth-bd">
                  <div class="card-header" id="headingfive">
                     <h5 class="mb-0">
                        ...
                        I Have More Quires Related Local SEO. Do You Guys Help Me?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordion">
                     <div class="card-body">
                       Feel free to contact us for any query related to local search engine optimization services. We are ready to answer all your quires over call, chat, or email.
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="contact_footer_box py-5"> 
        ...
        <div class="d-flex"  data-aos="fade-up" data-aos-duration="1000"> 
         ...
         <span>  
          ...
          <!-- <a href="tel:+1-212-913-9084"><span>Support</span>+1 (512) 717-7466</a> -->
        </span>
      </div>
    </div>
  </div>
