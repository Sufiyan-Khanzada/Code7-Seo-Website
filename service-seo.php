...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/service-seo" />
...
<section id="seo-banner" class="services-banner inner-banner orange-gradient">
   <div class="container">
...
Google but also generates a positive return on investment.</p>
         ...
         <div class="col-md-12">
            <form class="banner-form four-inputs"  data-aos="fade-up" data-aos-duration="1000" method="POST" action="https://searchmetop.com/include/sendmail.php">
                                               <input type="hidden" required name="page_url" value="service-seo.php" />
      ...
      <div class="row align-items-center order-change">
         <div class="col-sm-6">
            <div data-aos="zoom-in" data-aos-duration="1000">
               <img src="images/seo-img.png" alt="Image" class="img-responsive">
            </div>
         </div>
         <div class="col-sm-6">
