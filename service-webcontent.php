...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/service-webcontent" />
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-12">
            <form class="banner-form  four-inputs"  data-aos="fade-up" data-aos-duration="1000" method="POST" action="https://searchmetop.com/include/sendmail.php">
                                               <input type="hidden" required name="page_url" value="service-webcontent.php" />
      ...
      <div class="row align-items-center order-change">
         <div class="col-sm-6">
            <div data-aos="zoom-in" data-aos-duration="1000">
               <img src="images/content-img.png" alt="Image" class="img-responsive">
            </div>
         </div>
         <div class="col-sm-6">
      ...
      <div class="row">
         <div class="col-md-10 mx-auto">
            <div class="section-top text-center"  data-aos="fade-down" data-aos-duration="1000">
               ...
               <p>Take a look below to find answers to the questions we get asked the most regarding content services.</p>
            </div>
         </div>
      </div>
      <div class="row">
            ...
            <div id="accordion" class="my-5"  data-aos="fade-right" data-aos-duration="1000">
               <div class="card  first-bd">
                  <div class="card-header" id="headingOne">
                     <h5 class="mb-0">
                       ...
                       How Can Content Services Benefit My Business?
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                     <div class="card-body">
                        It is imperative to create relevant and impressive content to enhance the popularity of your brand over online platforms. Fortunately, here we help businesses to create valuable content according to the requirements of customers.
                     </div>
                  </div>
               </div>
               <div class="card  second-bd">
                  <div class="card-header" id="headingTwo">
                    ...
                    How Do I Know That You Will Provide Me Quality Content?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                     <div class="card-body">
                     We provide a 100% plagiarism-free Copyscape report along with your required content to prove the premium quality of work.
                     </div>
                  </div>
               </div>
               <div class="card  third-bd">
                  <div class="card-header" id="headingThree">
                     <h5 class="mb-0">
                      ...
                      What Industries Does SEO TOP SEARCH Cater To?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                     <div class="card-body">
                     By performing comprehensive research, we create effective and valuable content for clients from a wide spectrum of industries.
                     </div>
                  </div>
               </div>
               <div class="card  forth-bd">
                  <div class="card-header" id="headingfour">
                     <h5 class="mb-0">
                       ...
                       What Will Happen If I Don’t Like the Quality of Content?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                     <div class="card-body">
                     If you will not be satisfied with the quality of work, we will appoint a different writer for your project or simply provide you a refund.
                     </div>
                  </div>
               </div>
               <div class="card  fifth-bd">
                  <div class="card-header" id="headingfive">
                     <h5 class="mb-0">
                        ...
                        Do You Provide Content Revision Services?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordion">
                     <div class="card-body">
                       Yes, here we provided end-to-end content services. Ensure to fill out the contact us form or call us to connect with veteran’s website content writer. For any query related to content writing feel free to speak with us.
                     </div>
                  </div>
               </div>
            </div>
