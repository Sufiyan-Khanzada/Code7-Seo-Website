            ...
            <div class="row align-items-center">
               <div class="col-md-2 col-3">
                  <div class="logo-main-sec">
                     <a href="index.php"><img src="images/seo logo.png" style=" max-width: 150%;" class="img-responsive" alt="SEARCH ME TOP"></a>
                  </div>
               </div>
                           ...
                           <ul class="navbar-nav align-items-center">
                              ...
                              <li  class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a href="service-link.php" class="dropdown-item">Link Building</a></li>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                           <ul class="main-nav navbar-nav align-items-center">
                              ...
                              <li  class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a href="service-social-media.php" class="dropdown-item"><img src="images/drp-social%20media.png" alt=""> Social Media Marketing</a></li>
