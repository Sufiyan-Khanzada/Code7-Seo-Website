...
<div class="row">
   <div class="col-md-12">
      ...
      <form  id="package_form" method="POST" action="https://searchmetop.com/include/sendmail.php">
                 ...
                 <input type="hidden" required name="page_url" value="https://searchmetop.com/service-link" />
...
<section id="link-banner" class="services-banner inner-banner orange-gradient">
   <div class="container">
      <div class="row align-items-center">
         ...
         <div class="col-md-12">
            <form class="banner-form four-inputs"  data-aos="fade-up" data-aos-duration="1000" method="POST" action="https://searchmetop.com/include/sendmail.php">
                                               <input type="hidden" required name="page_url" value="service-link.php" />
      ...
      <div class="row align-items-center order-change">
         <div class="col-sm-6">
            <div data-aos="zoom-in" data-aos-duration="1000">
               <img src="images/link-img.png" alt="Image" class="img-responsive">
            </div>
         </div>
         <div class="col-sm-6">
...
<section class="packages-section all-section">
   <div class="container">
      ...
      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
         ...
         <a class="nav-item nav-link active" id="nav-link-tab" data-toggle="tab" href="#nav-link" role="tab" aria-controls="nav-link" aria-selected="false">Link Building</a>
      </div>
      </nav>
      ...
      <div class="row">
         <div class="col-md-10 mx-auto">
            <div class="section-top text-center"  data-aos="fade-down" data-aos-duration="1000">
               ...
               <p>Take a look below to find answers to the questions we get asked the most about link building.</p>
            </div>
         </div>
      </div>
      <div class="row">
            ...
            <div id="accordion" class="my-5"  data-aos="fade-right" data-aos-duration="1000">
               <div class="card  first-bd">
                  <div class="card-header" id="headingOne">
                     <h5 class="mb-0">
                        ...
                        How Can SEO Backlinking Service Benefit My Website Ranking?
                  ...
                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                     <div class="card-body">
                        To maximize organic traffic and business visibility, it is crucial to perform link building. At SEO TOP SEARCH, we help businesses to reach customers through effective link building. 
                     </div>
                  </div>
               </div>
               <div class="card  second-bd">
                  <div class="card-header" id="headingTwo">
                     ...
                     Do Link Building Firms Generate Leads for Businesses?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                     <div class="card-body">
                       When it comes to generating organic leads through top search engines, noting can benefit you more than link building. At SEO TOP SEARCH, we help businesses of all sectors to create powerful backlinks and leads. 
                     </div>
                  </div>
               </div>
               <div class="card  third-bd">
                  <div class="card-header" id="headingThree">
                     ...
                     Which Type of Business Needs Link Building?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                     <div class="card-body">
                      Through effective link building, any type of brand can attract more audiences. If you want to get a top position over popular search engines then you will need to invest in link building.
                     </div>
                  </div>
               </div>
               <div class="card  forth-bd">
                  <div class="card-header" id="headingfour">
                     <h5 class="mb-0">
                        ...
                        How to Figure Out Best Link Building Company?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefour" class="collapse" aria-labelledby="headingfour" data-parent="#accordion">
                     <div class="card-body">
                      If you want to improve your website visibility then our experienced link building team is at your service. We help you to move your business to new heights with result-oriented link building. 
                     </div>
                  </div>
               </div>
               <div class="card  fifth-bd">
                  <div class="card-header" id="headingfive">
                     <h5 class="mb-0">
                        ...
                        I Want to Improve My Website Ranking. Do You Guys Help Me with Link Building?
                        <i class="fa fa-minus float-right" aria-hidden="true"></i>
                        </button>
                     </h5>
                  </div>
                  <div id="collapsefive" class="collapse" aria-labelledby="headingfive" data-parent="#accordion">
                     <div class="card-body">
                        Fill out the contact us form shared in the below passage to benefit from our experienced link builders. For any query related to link building feel free to contact us on call, chat, or email.
                     </div>
                  </div>
               </div>
            </div>
